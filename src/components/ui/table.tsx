...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      "h-11 px-4 text-left align-middle font-semibold text-muted-foreground tracking-tight [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ...
    className={cn(
      "p-4 align-middle leading-normal text-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
