...
export const metadata: Metadata = {
  title: "Privacy Settings | Ravenshaw Moments Dashboard",
  description: "Configure your public visibility, email exposure, phone protection, and search directory preferences.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile/privacy`,
  },
};
...
export default async function DashboardProfilePrivacyPage() {
