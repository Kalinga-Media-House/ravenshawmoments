...
export const metadata: Metadata = {
  title: "Edit Profile | Ravenshaw Moments Dashboard",
  description: "Update your full name, username, biography, gender, date of birth, and identity visuals.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile/edit`,
  },
};
