...
export const metadata: Metadata = {
  title: "Profile Settings | Ravenshaw Moments Dashboard",
  description: "Manage your account privacy rules and claim your academic roll number or registration credentials.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile/settings`,
  },
};
