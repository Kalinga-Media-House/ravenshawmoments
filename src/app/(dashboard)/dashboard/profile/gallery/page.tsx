...
export const metadata: Metadata = {
  title: "My Gallery | Ravenshaw Moments Dashboard",
  description: "Manage, upload, and organize up to 50 photos showcasing campus memories and achievements.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile/gallery`,
  },
};
...
export default async function DashboardProfileGalleryPage() {
