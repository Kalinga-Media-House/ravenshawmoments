...
export const metadata: Metadata = {
  title: "My Profile | Ravenshaw Moments Dashboard",
  description: "Manage your academic profile, view verified awards, showcase gallery memories, and configure privacy settings.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile`,
  },
};
