...
export const metadata: Metadata = {
  title: "My Certificates | Ravenshaw Moments Dashboard",
  description: "View and verify your official competition winner certificates and event participation credentials.",
  alternates: {
    canonical: `${env.NEXT_PUBLIC_APP_URL}/dashboard/profile/certificates`,
  },
};
...
export default async function DashboardProfileCertificatesPage() {
