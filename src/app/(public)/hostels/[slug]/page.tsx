...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${resolvedParams.slug} | Hostel`,
  };
}
...
export default async function HostelDetailPage({
  ...
  // const res = await getPublicHostelBySlug(slug);
        ...
        <div className="lg:col-span-2 space-y-12">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed text-lg">
              Detailed description of the hostel goes here. It provides a comprehensive overview of its history, objectives, and community impact.
            </p>
          </section>
