...
export const metadata: Metadata = {
  ...
  description: "Browse the official departments directory of Ravenshaw University.",
};
...
export default async function DepartmentDirectoryPage({
  ...
  // const res = await listPublicDepartment({ query: q, type: typeFilter, page });
  
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
        <div>
          <h1 className="text-4xl font-extrabold tracking-tight mb-2">Department</h1>
          <p className="text-lg text-muted-foreground">
            Explore the vibrant departments ecosystem at Ravenshaw.
          </p>
        </div>
