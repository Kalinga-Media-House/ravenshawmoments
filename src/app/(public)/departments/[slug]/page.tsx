...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${resolvedParams.slug} | Department`,
  };
}
        ...
        <div className="lg:col-span-2 space-y-12">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed text-lg">
              Detailed description of the department goes here. It provides a comprehensive overview of its history, objectives, and community impact.
            </p>
          </section>
