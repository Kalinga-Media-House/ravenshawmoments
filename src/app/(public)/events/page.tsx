...
export const metadata: Metadata = {
  title: "Upcoming Events | Ravenshaw Moments",
  description: "Discover academic and cultural events across the campus.",
};
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6">
        <div>
          ...
          <p className="text-lg text-muted-foreground">Discover academic and cultural events across the campus.</p>
        </div>
