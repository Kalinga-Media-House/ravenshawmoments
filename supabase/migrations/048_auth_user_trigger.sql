-- =============================================================================
-- Ravenshaw Moments
-- Migration : 048_auth_user_trigger.sql
-- =============================================================================
-- PURPOSE
-- Automatically creates a public.profiles record when a new auth.users account
-- is created via Supabase Auth signup.
-- =============================================================================
...
BEGIN
    ...
    -- Provide a fallback profile type (defaults to 'student' in schema anyway)
